...
public struct AnyHook<Request, Response> {
    ...
    public init(shouldStart: ShouldStart? = nil,
                beginRouter: BeginRouter? = nil,
                shouldHandler: ShouldHandler? = nil,
                finishRouter: FinishRouter? = nil) {
        self.shouldStart = shouldStart
        self.beginRouter = beginRouter
        self.shouldHandler = shouldHandler
